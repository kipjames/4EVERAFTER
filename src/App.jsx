  ...
  return (
    ...
    >
      {editing ? (
        ...
        <>
          <p style={{ fontSize: 14, lineHeight: 1.88, color: "#1a0a00", margin: 0, textAlign: "justify" }}>{text}</p>
          {isMobile ? (
  ...
  const handlePrint = () => {
    const printContent = `<html><head>
      ...
      <style>
        ...
        .paper { background: transparent; border-radius: 8px; padding: 0.35in 0.4in; height: 9in; box-sizing: border-box; overflow: hidden; }
